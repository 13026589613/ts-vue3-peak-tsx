//ÇëÒýÈë proj4.js ºÍ proj4leaflet.js
...
L.tileLayer.baidu = function (option) {
    ...
    switch (option.layer) {
        ...
        case "custom"://Custom ¸÷ÖÖ×Ô¶¨ÒåÑùÊ½
            //¿ÉÑ¡Öµ£ºdark,midnight,grayscale,hardedge,light,redalert,googlelite,grassgreen,pink,darkgreen,bluish
            ...
            // layer = L.tileLayer('http://localhost:8080/bd-offline-map-tiles/{z}/{x}/{y}.png', {
            //     name: option.name, subdomains: "012", tms: true
            // });
            break;
        ...
        case "img":
            layer = L.layerGroup([
				L.tileLayer.baidu({ name: "µ×Í¼", layer: 'img_d', bigfont: option.bigfont }),
				L.tileLayer.baidu({ name: "×¢¼Ç", layer: 'img_z', bigfont: option.bigfont })
            ]);
            break;
    }
    return layer;
