...
;(function() {
  ...
  x.extend(Ka.prototype, {
    ...
    ui: function(a) {
      a instanceof H &&
        ((this.wc = this.ve.Jm(a, this.Vb)), (this.ef = H.TL(a) ? new H(a.lng, a.lat) : this.ve.qh(this.wc, this.Vb)))
    },
    yg: function(a, b) {
      a = Math.round(a) || 0
      b = Math.round(b) || 0
    ...
    wb: function() {
      return this.ls && this.ls instanceof L
        ? new L(this.ls.width, this.ls.height)
        : new L(this.Ua.clientWidth, this.Ua.clientHeight)
    },
    we: function(a) {
      a && a instanceof L
        ? ((this.ls = a), (this.Ua.style.width = a.width + 'px'), (this.Ua.style.height = a.height + 'px'))
        : (this.ls = p)
    },
    Ka: t('ef'),
    fa: t('Ha'),
    ...
    Nt: function(a) {
      ...
      if (a) {
        ...
        G() && x.ea.yN
          ...
          : ((this.M.se = a), this.dispatchEvent(new M('onsetcustomstyles', a)), this.OL(b.M.se.geotableId))
        var c = {
          style: a.style,
        }
        ...
        Oa(5050, c)
        a.style &&
          (c = b.M.dm[a.style] ? b.M.dm[a.style].backColor : b.M.dm.normal.backColor) &&
          (this.Na().style.backgroundColor = c)
      }
    },
    SX: function(a) {
      this.controls ||
  ...
  z.IL = {
    TILE_BASE_URLS: [
      'ss0.baidu.com/5bwHcj7lABFU8t_jkk_Z1zRvfdw6buu',
    ...
    TILE_ONLINE_URLS: [
      'ss0.bdstatic.com/8bo_dTSlR1gBo1vgoIiO_jowehsv',
    ...
    TIlE_PERSPECT_URLS: [
      'ss0.bdstatic.com/-OR1cTe9KgQFm2e88IuM_a',
      'ss0.bdstatic.com/-ON1cTe9KgQFm2e88IuM_a',
      'ss0.bdstatic.com/-OZ1cTe9KgQFm2e88IuM_a',
      'ss0.bdstatic.com/-OV1cTe9KgQFm2e88IuM_a',
    ],
    geolocControl: 'sp2.baidu.com/8LkJsjOpB1gCo2Kml5_Y_D3',
    TILES_YUN_HOST: [
      'sp0.baidu.com/-eR1bSahKgkFkRGko9WTAnF6hhy',
      'sp0.baidu.com/-eN1bSahKgkFkRGko9WTAnF6hhy',
      'sp0.baidu.com/-eZ1bSahKgkFkRGko9WTAnF6hhy',
    ...
    pano: [
      'ss0.bdstatic.com/5LUZemba_QUU8t7mm9GUKT-xh_',
      'ss0.bdstatic.com/5LUZemfa_QUU8t7mm9GUKT-xh_',
    ...
    main_domain_cdn: {
      baidu: [
        'ss0.bdstatic.com/9_Q4vHSd2RZ3otebn9fN2DJv',
        'ss0.baidu.com/9_Q4vXSd2RZ3otebn9fN2DJv',
  ...
  z.ma =
    z.url.proto + ('2' == z.ou ? z.url.domain.main_domain_cdn.other[0] : z.url.domain.main_domain_cdn.baidu[0]) + '/'
  z.ma = ''
  ...
  function ub(a) {
    var b = $a()
    b >= a.Uz
      ? (Va(a.k.ta) && a.k.ta(a.k.hc(1)),
        Va(a.k.finish) && a.k.finish(),
        0 < a.Zf.length && ((b = a.Zf[0]), (b.Zf = [].concat(a.Zf.slice(1))), b.start()))
      : ((a.qy = a.k.hc((b - a.Lu) / a.k.duration)),
        Va(a.k.ta) && a.k.ta(a.qy),
        a.zF ||
  ...
  var F = {
    ...
    OO: new L(12, 36),
    RF: new L(13, 1),
    oa: '/static/offline-map/images/',
    H2: 'http://api0.map.bdimg.com/images/',
    SF: '../images/markers_new.png',
    MO: 24,
    NO: 73,
    cC: {
      北京: {
  ...
  x.ea.rg
    ? (x.extend(F, {
        uK: 'url(./images/ruler.cur),crosshair',
        Wb: '-moz-grab',
        Dd: '-moz-grabbing',
      }),
    ...
    : x.ea.XJ || x.ea.yN
    ? x.extend(F, {
        uK: 'url(./images/ruler.cur) 2 6,crosshair',
        Wb: 'url(' + F.oa + 'openhand.cur) 8 8,default',
        Dd: 'url(./images/closedhand.cur) 8 8,move',
      })
    : x.extend(F, {
        uK: 'url(./images/ruler.cur),crosshair',
        Wb: 'url(' + F.oa + 'openhand.cur),default',
        Dd: 'url(./images/closedhand.cur),move',
      })
          ...
          (c.alog('cus.on', 'time', function(a) {
            ...
            if ('[object Object]' === a.toString()) {
              for (var g in a)
                'page' == g
                  ? (b.page = a[g])
                  : ((e = parseInt(a[g], 10)), 0 < e && /^z_/.test(g) && ((d = o), (b[g] = e)))
          ...
          c.alog('cus.on', 'count', function(a) {
            ...
            if (a instanceof Array)
              for (var e = 0; e < a.length; e++)
                /^z_/.test(a[e]) ? ((d = o), (b[a[e]] = 1)) : /^page:/.test(a[e]) && (b.page = a[e].substring(5))
  ...
  x.object.extend(I, {
    ...
    s3: {},
    aG: {
      MP: 'getmodules?v=2.0&t=20140707',
      oU: 5e3,
    },
    zC: q,
    Md: {
        ...
        if (d.Bd == this.Fj.hG) {
          ...
          e.zC == q &&
            ...
            setTimeout(function() {
              ...
              if (a.length > 0) {
                console.log(a)
                // Pb('http://localhost:8080/bd-offline-map-tiles/getmodules.js')
                Pb('http://192.168.150.23:8099/bd-offline-map-tiles/getmodules.js')
              } else {
                e.LK()
              }
            }, 1))
    ...
    gV: function(a, b) {
      for (var c = this.Md.Pv, d = o, e = 0, f = c.length; e < f; e++)
  ...
  x.object.extend(Wb.prototype, {
    ...
    om: function(a) {
      for (var b = 0, c = this.ac.length; b < c; b++) if (this.ac[b].id == a) return this.ac[b]
    },
    AD: t('ac'),
    XE: function(a) {
      for (var b = 0, c = this.ac.length; b < c; b++)
        this.ac[b].id == a && ((r = this.ac.splice(b, 1)), b--, (c = this.ac.length))
    },
    xe: function() {
      var a = this
  ...
  x.object.extend(eb.prototype, {
    ...
    kf: t('ul'),
    uV: function(a) {
      return !(a instanceof eb) || this.yj() || a.yj()
        ? q
        : a.Je > this.Je && a.De < this.De && a.Ie > this.Ie && a.Ce < this.Ce
    },
    Ka: function() {
    ...
    ft: function(a) {
      if (
        !(a instanceof eb) ||
        Math.max(a.Je, a.De) < Math.min(this.Je, this.De) ||
        Math.min(a.Je, a.De) > Math.max(this.Je, this.De) ||
        Math.max(a.Ie, a.Ce) < Math.min(this.Ie, this.Ce) ||
    ...
    bs: function(a) {
      return !(a instanceof H) || this.yj()
        ? q
        : a.lng >= this.Je && a.lng <= this.De && a.lat >= this.Ie && a.lat <= this.Ce
    },
    extend: function(a) {
      if (a instanceof H) {
        var b = a.lng,
  ...
  x.extend(R.prototype, {
    ...
    zb: function(a, b, c, d, e) {
      if (a)
        return (b = this.Lc(b)), this.qh(new H(c.lng + b * (a.x - d.width / 2), c.lat - b * (a.y - d.height / 2)), e)
    },
    Lc: function(a) {
  ...
  z.Se(function(a) {
    ...
    ;(x.ea.la && 8 > x.ea.la) || 'BackCompat' === document.compatMode
    ...
    a.addEventListener('clearoverlays', function() {
      ...
      a = 0
      for (var d = b.ye.length; a < d; a++)
        b.ye[a].ii !== q && (b.ye[a].remove(), (b.ye[a] = p), b.ye.splice(a, 1), a--, d--)
    })
  ...
  kc.KE = [0.09, 0.005, 1.0e-4, 1.0e-5]
  ...
  x.extend(lc.prototype, {
    ...
    initialize: function(a) {
      ...
      this.Hj()
      this.V &&
        x.K(this.V, G() ? 'touchstart' : 'mousedown', function(a) {
          na(a)
        })
      return this.V
    },
    draw: function() {
      ...
      this.z.ya = new L(
        -Math.round(this.z.width / 2) - Math.round(this.z.Nx),
        -Math.round(this.z.height / 2) - Math.round(this.z.Nx)
      )
  ...
  x.extend(Ac.prototype, {
    ...
    ev: function(a, b) {
      ...
      for (
        var c = [], d = b / 6378800, e = (Math.PI / 180) * a.lat, f = (Math.PI / 180) * a.lng, g = 0;
        360 > g;
        g += 9
      ) {
        var i = (Math.PI / 180) * g,
          ...
          i = new H(
            (((f -
              Math.atan2(Math.sin(i) * Math.sin(d) * Math.cos(e), Math.cos(d) - Math.sin(e) * Math.sin(k)) +
              Math.PI) %
              (2 * Math.PI)) -
              Math.PI) *
              (180 / Math.PI),
  ...
  x.extend(Cc.prototype, {
    ...
    vf: function() {
      ...
      0 == this.th &&
        (this.Ni && (clearTimeout(this.Ni), (this.Ni = p)),
    ...
    xm: function(a, b, c) {
      ...
      for (d = this.Rc.length; l < d; l++)
        (A = this.Rc[l][0]),
          ...
          (n = p),
          m
            ? ((n = m.style), (n.left = u + 'px'), (n.top = v + 'px'), m.Xe || this.nn.push([A, i, m]))
            : (0 < this.Le.length
                ? ((m = this.Le.shift()), m.getContext('2d').clearRect(-c / 2, -c / 2, w, w), (n = m.style))
              ...
              (n.top = v + 'px'),
              -1 < y.indexOf('bg') &&
                ((u = '#F3F1EC'), this.map.M.zo && (u = this.map.M.zo), (n.background = u ? u : '')),
              this.nn.push([A, i, m])),
          (m.style.visibility = '')
      l = 0
    ...
    SD: function(a, b) {
      return this.map.va() === Na
        ? 'TILE-' + b.ca + '-' + this.map.Bw + '-' + a[0] + '-' + a[1] + '-' + a[2]
    ...
    cI: function(a) {
      for (var b = this.Km.concat(this.Wf), c = b.length, d = 0; d < c; d++) {
        ...
        if (!e.TH && !((e.mp && !this.map.Ub()) || (e.$L && this.map.Ub()))) {
          ...
          e.Pb &&
            ((e.Pb.style.left = Math.ceil(v + y) - u[0] + 'px'),
      ...
      if (g.Nm) {
        ...
        if (g.Gb && !xb(g.Gb) && e.Pb) {
          ...
          if (x.ea.la <= 6 && x.ea.la > 0 && g.fJ)
            g.Gb.style.cssText =
              g.Gb.style.cssText +
              (';filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src="' + g.src + '",sizingMethod=scale);')
        }
        var c = a.VE - a.cV,
          d
        for (d in b) {
  ...
  x.extend(Dc.prototype, {
    ...
    getTilesUrl: function(a, b) {
      var c = ''
      this.uh.tileUrlTemplate &&
        ((c = this.uh.tileUrlTemplate.replace(/\{X\}/, a.x)),
        (c = c.replace(/\{Y\}/, a.y)),
        (c = c.replace(/\{Z\}/, b)))
      return c
    },
  ...
  function bb(a) {
    this.dV = [
      ...
      z.url.proto + z.url.domain.TILE_ONLINE_URLS[4] + '/gvd/?',
    ]
    this.k = {
      QK: q,
    }
  ...
  var Rc = [
    ...
    Sc = [
      ...
      z.url.proto + z.url.domain.TILE_ONLINE_URLS[4] + '/tile/',
    ],
    Tc = {
      dark: 'dl',
      light: 'll',
  ...
  Uc.getTilesUrl = function(a, b, c) {
    var x = a.x,
      ...
      e = 1,
      z = b
    // return 'http://localhost:8080/bd-offline-map-tiles/' + z + '/' + x + '/' + y + '.png'
    return 'http://192.168.150.23:8099/bd-offline-map-tiles/' + z + '/' + x + '/' + y + '.png'
  }
  var La = new Qc('\u5730\u56fe', Uc, {
      tips: '\u663e\u793a\u666e\u901a\u5730\u56fe',
      maxZoom: 19,
  ...
  Vc.getTilesUrl = function(a, b) {
    ...
    return (url =
      this.cO[Math.abs(c + d) % this.cO.length] +
      this.map.Vb +
      '/' +
      this.map.Bw +
      '/3/lv' +
  ...
  Xc.getTilesUrl = function(a, b) {
    ...
    return (
      ...
      b +
      '&styles=sl' +
      (6 == x.ea.la ? '&color_dep=32&colors=50' : '') +
      '&udt=20141015'
    ).replace(/-(\d+)/gi, 'M$1')
  }
          ...
          (e == this.page
            ...
            : 1 <= e &&
              ...
              ((d =
                ...
                e +
                ']</a></span>'),
              a.push(d.replace('{temp3}', "BMap.I('" + this.ca + "').toPage(" + e + ');'))))
      c > this.Hd ||
        a.push(
  ...
  function Ma(a, b) {
    function c() {
      e.k.visible
        ? ('inter' === e.Fe && e.k.haveBreakId && e.k.indoorExitControl === o ? x.D.show(e.sA) : x.D.U(e.sA),
          this.k.closeControl && this.wf && this.C && this.C.Na() === this.B ? x.D.show(e.wf) : x.D.U(e.wf),
          this.k.forceCloseControl && x.D.show(e.wf))
        : (x.D.U(e.wf), x.D.U(e.sA))
    }
    ...
    this.Rg = []
    this.ur = []
    'cvsRender' == this.dk || Hd()
      ? ((this.Wj = 90), (this.Yj = -90))
      : 'cssRender' == this.dk && ((this.Wj = 45), (this.Yj = -45))
    this.yr = q
    var e = this
    this.$n = function() {
      this.dk === 'flashRender'
  ...
  x.extend(Ma.prototype, {
    ...
    rB: function() {
      if (this.C)
        for (var a = this.C.qx(), b = 0; b < a.length; b++)
          (a[b] instanceof T || a[b] instanceof qc) && a[b].point && this.ua.push(a[b])
    },
    nF: ba('C'),
    Pt: function(a) {
      this.Jf = a || 'none'
    ...
    Yq: function() {
      return Sa() && !G() && 'javascript' != this.k.panoramaRenderer
        ? 'flashRender'
        : !G() && Lb()
        ? 'cvsRender'
        : 'cssRender'
  ...
  function Hd() {
    ...
    if (!window.WebGLRenderingContext || (x.platform.Gm && -1 == navigator.userAgent.indexOf('Android 5')))
      return (Rd = q)
    var a = document.createElement('canvas'),
      b = p
    try {
          ...
          if (a.id != b.Uv) {
            ...
            if (b.pl) {
              ...
              c =
                ...
                Math.cos(Mb(c)) * Math.cos(Mb(i)) * Math.sin(f / 2) * Math.sin(f / 2)
  ...
  x.extend(Vd, {
    kp: function(a, b, c, d) {
      if (!b || !c || !c.lngLat || !c.panoInstance) d()
        ...
        this.fo.aC(b, function(b) {
          b
            ? e.fo.qj(c.lngLat, Vd.dP, function(b) {
                if (b && b.id) {
                  var f = b.id,
                    k = b.vh,
                    b = b.wh,
    ...
    TR: function(a, b, c, d) {
      ...
      !d || !a.split(d)[0]
        ? ((d = a), (a = ''))
        : ((d = a.split(d)[0]), (e = d.lastIndexOf('<')), (d = a.substring(0, e)), (a = a.substring(e)))
      e = []
      var f = Vd.zu.width,
        g = Vd.zu.height
      e.push(d)
      e.push(
        "<div id='infoWndPano' class='panoInfoBox' style='height:" + g + 'px;width:' + f + "px; margin-top: -19px;'>"
      )
      e.push(
  ...
  function Ce(a, b) {
    ...
    c.options.Uk
      ? (c.Nb.style[fe] = 'translate(' + c.x + 'px,' + c.y + 'px)' + Be)
  ...
  Ce.prototype = {
    ...
    gQ: function() {
      !this.rh &&
        !this.Wk &&
        !(this.Vl || (this.ty == this.Nb.offsetWidth * this.scale && this.Fp == this.Nb.offsetHeight * this.scale)) &&
        this.refresh()
    },
    Ev: function(a) {
      var b
      this[a + 'Scrollbar']
        ? (this[a + 'ScrollbarWrapper'] ||
            ((b = Wd.createElement('div')),
            this.options.eF
              ? (b.className = this.options.eF + a.toUpperCase())
              : (b.style.cssText =
                  'position:absolute;z-index:100;' +
                  ('h' == a
                    ? 'height:7px;bottom:1px;left:2px;right:' + (this.Ci ? '7' : '2') + 'px'
                    : 'width:7px;bottom:' + (this.mi ? '7' : '2') + 'px;top:2px;right:1px')),
            (b.style.cssText +=
              ';pointer-events:none;' +
              de +
            ...
            (b.style.cssText +=
              ...
              Be),
            this.options.Bi &&
              (b.style.cssText += ';' + de + 'transition-timing-function:cubic-bezier(0.33,0.66,0.66,1)'),
            this[a + 'ScrollbarWrapper'].appendChild(b),
            (this[a + 'ScrollbarIndicator'] = b)),
          'h' == a
            ? ((this.AL = this.BL.clientWidth),
              (this.IX = Xd.max(Xd.round((this.AL * this.AL) / this.ty), 8)),
              (this.HX.style.width = this.IX + 'px'))
            : ((this.AO = this.BO.clientHeight),
              (this.P_ = Xd.max(Xd.round((this.AO * this.AO) / this.Fp), 8)),
              (this.O_.style.height = this.P_ + 'px')),
          this.lB(a, o))
        : this[a + 'ScrollbarWrapper'] &&
          (re && (this[a + 'ScrollbarIndicator'].style[fe] = ''),
    ...
    xr: function(a, b) {
      this.Wk ||
        ...
        (b = this.vn ? b : 0),
        this.options.Uk
          ? (this.Nb.style[fe] = 'translate(' + a + 'px,' + b + 'px) scale(' + this.scale + ')' + Be)
          : ((a = Xd.round(a)), (b = Xd.round(b)), (this.Nb.style.left = a + 'px'), (this.Nb.style.top = b + 'px')),
        (this.x = a),
        (this.y = b),
        this.lB('h'),
        this.lB('v'))
    ...
    lB: function(a, b) {
      ...
      this[a + 'Scrollbar'] &&
        ...
        0 > c
          ? (this.options.nD ||
              ((c = this[a + 'ScrollbarIndicatorSize'] + Xd.round(3 * c)),
              8 > c && (c = 8),
        ...
        (this[a + 'ScrollbarWrapper'].style[ke] = '0'),
        (this[a + 'ScrollbarWrapper'].style.opacity = b && this.options.Bx ? '0' : '1'),
        (this[a + 'ScrollbarIndicator'].style[fe] = 'translate(' + ('h' == a ? c + 'px,0)' : '0,' + c + 'px)') + Be))
    },
    rQ: function(a) {
      ...
      if ('select' != b && 'input' != b && 'textarea' != b)
        return (
          a.stopImmediatePropagation ? a.stopImmediatePropagation() : (a.bZ = o),
          a.stopPropagation(),
          a.preventDefault(),
          (this.Zw = this.KB = p),
          q
    ...
    Nv: function(a) {
      ...
      if (this.enabled) {
        ...
        this.options.zoom &&
          qe &&
          1 < a.touches.length &&
          ((d = Xd.abs(a.touches[0].pageX - a.touches[1].pageX)),
          (c = Xd.abs(a.touches[0].pageY - a.touches[1].pageY)),
          (this.w_ = Xd.sqrt(d * d + c * c)),
          (this.$x = Xd.abs(a.touches[0].pageX + a.touches[1].pageX - 2 * this.NF) / 2 - this.x),
          (this.ay = Xd.abs(a.touches[0].pageY + a.touches[1].pageY - 2 * this.OF) / 2 - this.y),
    ...
    QS: function(a) {
      ...
      if (this.options.zoom && qe && 1 < a.touches.length)
        (e = Xd.abs(a.touches[0].pageX - a.touches[1].pageX)),
          (f = Xd.abs(a.touches[0].pageY - a.touches[1].pageY)),
          (this.v_ = Xd.sqrt(e * e + f * f)),
          (this.Wk = o),
          (b = (1 / this.w_) * this.v_ * this.scale),
          b < this.options.Vk
            ? (b = 0.5 * this.options.Vk * Math.pow(2, b / this.options.Vk))
            : b > this.options.Xp && (b = 2 * this.options.Xp * Math.pow(0.5, this.options.Xp / b)),
        ...
        ;(6 > this.ew && 6 > this.fw) ||
          (this.options.xE &&
            (this.ew > this.fw + 5 ? ((f = this.y), (d = 0)) : this.fw > this.ew + 5 && ((e = this.x), (c = 0))),
          (this.rh = o),
          this.xr(e, f),
          (this.DC = 0 < c ? -1 : 0 > c ? 1 : 0),
          (this.EC = 0 < d ? -1 : 0 > d ? 1 : 0),
          300 < g - this.startTime && ((this.startTime = g), (this.au = this.x), (this.bu = this.y)),
      ...
      if (!(qe && 0 !== a.touches.length)) {
        ...
        if (b.Wk)
          ...
          if (b.rh) {
            ...
            f.Aa || g.Aa
              ? ((c = Xd.max(Xd.max(f.time, g.time), 10)),
                b.options.Yt &&
                  ((f = d - b.gw),
                  (g = e - b.hw),
                  Xd.abs(f) < b.options.Dy && Xd.abs(g) < b.options.Dy
                    ? b.scrollTo(b.gw, b.hw, 200)
                    : ((f = b.WI(d, e)), (d = f.x), (e = f.y), (c = Xd.max(f.time, c)))),
                b.scrollTo(Xd.round(d), Xd.round(e), c))
              : b.options.Yt
              ? ((f = d - b.gw),
                (g = e - b.hw),
                Xd.abs(f) < b.options.Dy && Xd.abs(g) < b.options.Dy
                  ? b.scrollTo(b.gw, b.hw, 200)
                  : ((f = b.WI(b.x, b.y)), (f.x != b.x || f.y != b.y) && b.scrollTo(f.x, f.y, f.time)))
              : b.io(200)
          } else {
            if (qe)
    ...
    io: function(a) {
      ...
      if (b == this.x && c == this.y) {
        if (
          (this.rh && ((this.rh = q), this.options.Yx && this.options.Yx.call(this)),
          this.mi &&
            this.options.Bx &&
            ('webkit' == Zd && (this.BL.style[ke] = '300ms'), (this.BL.style.opacity = '0')),
          this.Ci && this.options.Bx)
        )
          'webkit' == Zd && (this.BO.style[ke] = '300ms'), (this.BO.style.opacity = '0')
    ...
    xB: function() {
      ...
      a.Vl ||
        (a.Aj.length
          ? ((e = a.Aj.shift()), e.x == b && e.y == c && (e.time = 0), (a.Vl = o), (a.rh = o), a.options.Bi)
            ? (a.eJ(e.time), a.xr(e.x, e.y), (a.Vl = q), e.time ? a.ba(ye) : a.io(0))
            : ((g = function() {
                var i = Date.now(),
                  k
                if (i >= d + e.time) {
    ...
    bI: function(a, b, c, d, e) {
      ...
      0 < a && f > c
        ...
        : 0 > a && f > d && ((d += e / (6 / (6.0e-4 * (f / b)))), (b = (b * d) / f), (f = d))
      return {
        Aa: f * (0 > a ? -1 : 1),
    ...
    refresh: function() {
      ...
      if ('string' == typeof this.options.Yt) {
        ...
        this.ee % this.ru &&
          (this.Qe[this.Qe.length] = this.ee - this.Qe[this.Qe.length - 1] + this.Qe[this.Qe.length - 1])
        b = d = 0
        for (this.pf = []; d >= this.od; ) (this.pf[b] = d), (d -= this.yn), b++
        this.od % this.yn &&
          (this.pf[this.pf.length] = this.od - this.pf[this.pf.length - 1] + this.pf[this.pf.length - 1])
      }
      this.Ev('h')
      this.Ev('v')
    ...
    zoom: function(a, b, c, d) {
      ...
      this.options.Uk &&
        ...
        (this.Nb.style[he] = d + 'ms'),
        (this.Nb.style[fe] = 'translate(' + this.x + 'px,' + this.y + 'px) scale(' + c + ')' + Be),
        (this.Wk = q))
    },
  }
  ...
  x.extend(De.prototype, {
    ...
    ly: function(a, b) {
      if (b || !this.bk[this.Yc] || !(this.bk[this.Yc].panoId == a && 3 !== this.bk[this.Yc].recoType)) {
        var c = this,
          d = this.vH(a)
        !b && -1 !== d && this.bk[d] && 3 !== this.bk[d].recoType
          ? this.Jp(d)
          : this.lX(function(a) {
          ...
          if ((a = (a.srcElement || a.target).getAttribute('dataindex'))) {
            ...
            for (var d = b.getElementsByTagName('li'), e = 0, f = d.length; e < f; e++)
              d[e].childNodes[0].getAttribute('dataindex') === a
                ? x.D.Ta(d[e], 'pano_catlogLiActive')
                : x.D.Rb(d[e], 'pano_catlogLiActive')
          }
        })
        var a = K('div'),
          d = K('a'),
          ...
          g = K('span'),
          i = [
            'background:url(' + F.oa + 'panorama/catlog_icon.png) no-repeat;',
    ...
    Dl: function(a) {
      ...
      this.k.showCatalog &&
        (0 < this.Pi.length
          ? (Sa() ? this.CV() : this.FV(), (this.Pc.offsetLeft = 60))
          : (this.Gs && (this.B.removeChild(this.Gs), (this.Gs = p), (this.Pc.fg.style.left = '0px')),
            this.Mi && (this.B.removeChild(this.Mi), (this.Mi = p)),
      ...
      Sa() &&
        ...
        this.k.showExit &&
        this.Vz &&
        ((this.Pc.offsetLeft += this.eg.width + 8), this.Gs ? (this.Gs.innerHTML = this.Vz) : this.DV())
      this.Wh.innerHTML = b
      this.Wh.style.width = (this.eg.width + 8) * a.length + 8 + 'px'
      a = this.B.offsetWidth
      b = this.Wh.offsetWidth
      this.Pc.Ns && (b += this.Pc.Ns())
      b < a - 2 * this.Pc.Gi - this.Pc.offsetLeft
        ? (this.B.style.width = b + this.Pc.offsetLeft + 'px')
        : ((this.B.style.width = isNaN(Number(this.k.maxWidth)) === o ? this.k.maxWidth : this.k.maxWidth + 'px'),
          b < this.B.offsetWidth - 2 * this.Pc.Gi - this.Pc.offsetLeft &&
            (this.B.style.width = b + this.Pc.offsetLeft + 'px'))
      this.Pc.refresh()
      this.mB = this.Wh.children
      this.Wh.appendChild(this.fk)
      this.fk.style.left = '-100000px'
      a = this.vH(this.P.Xb(), this.N0)
      ;-1 !== a && this.Jp(a)
    },
    $W: function(a) {
    ...
    UW: function(a) {
      for (var b, c, d, e, f = [], g = this.eg.height, i = this.eg.width, k = 0; k < a.length; k++)
        (b = a[k]),
          ...
          3 === recoType
            ? Sa()
              ? ((this.Vz = b), (this.nW = d), a.splice(k, 1), k--)
              : ((b =
                  '<a href="javascript:void(0);" class="pano_photo_item" data-index="' +
                  k +
                  '"><img style="width:' +
  ...
  He.prototype = {
    ...
    refresh: function() {
      ...
      this.fg &&
        (this.fg.children[0].style.marginTop = this.Dr.children[0].style.marginTop =
    ...
    scrollTo: function(a) {
      a =
        a < this.Ug.offsetLeft
          ? Math.ceil((a - this.Gi - this.co) / this.Lr) * this.Lr + this.co + this.Gi - 8
          : Math.ceil((a - this.Gi) / this.Lr) * this.Lr + this.Gi
