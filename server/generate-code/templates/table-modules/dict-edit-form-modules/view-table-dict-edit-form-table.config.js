...
import {
  ...
  renderHigherFilter,
} from '@/views/modules/components/dictTableColumns/table-columns'
...
const renderOperate = (_this: any): Operate[] => [
  {
    ...
    isBus: false, // 开启总线标示
    APIModules: { ..._this.$Api.apiModulesList.${tableEntity.lowerTableName}.init${tableEntity.upperTableName}InfoByParams },
  ...
  {
    key: 'btn-delete',
    rowKey: '${tableEntity.pk.lowerColumnName}s',
    color: 'red',
    text: '删除',
    roles: true,
    confirm: true,
    ...
    isBus: false, // 开启总线标示
    APIModules: { ..._this.$Api.apiModulesList.${tableEntity.lowerTableName}.delete${tableEntity.upperTableName}ByParams },
    callback: () => {
...
const renderButtonArrays = (_this: any): TableBtnObjects => ({
  ...
  update: Object.assign(
    ...
    },
    {
      ...
      operateFetchAPI: { ..._this.$Api.apiModulesList.${tableEntity.lowerTableName}.init${tableEntity.upperTableName}InfoByParams },
    }
  ),
  delete: Object.assign(
    ...
    },
    {
      ...
      operateFetchAPI: { ..._this.$Api.apiModulesList.${tableEntity.lowerTableName}.delete${tableEntity.upperTableName}ByParams },
    }
  ),
})
